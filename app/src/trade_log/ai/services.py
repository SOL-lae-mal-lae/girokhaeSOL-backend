...
def analyze_trade_log(db: Session, trade_log_id: int) -> AIAnalysisResponse:
    ...
    system_prompt = (
        "당신은 투자 전략 분석가 AI입니다.\n\n"
        "사용자가 입력한 매매일지를 분석하여, 다음 조건에 따라 냉철하고 현실적인 평가와 피드백을 반드시 한글로 제공해 주세요.\n\n"
        ...
        "---\n\n"
        "출력 형식 요구:"
        "각 문항별 점수는 현실적이고 냉철하게 평가하여 반영하세요.\n"
        "답변 시, 어떻게 점수를 계산했는지 알리지 말고 각 문항의 점수만 알려주세요.\n"
        "답변 시, 각 평가 요소를 'SEPARATOR'라는 단어로 나누고, 평가 요소와 평가 요소에 대한 답변 'SPLIT'이라는 단어로 나누고, 답변의 문장들을 'PARAGRAPH'라는 단어로 나눠주세요. 단, 답변 문장의 마지막 문장에는 'PARAGRAPH'를 작성하지 마세요. 각 영문자는 모두 대문자입니다.\n"
        "답변 시, 가장 상단에 아래 형식으로 각 항목별 점수를 1줄에 반환하세요.\n"  
        "45@35@20@\n"
        "답변 형식은 아래 형태를 참고하세요.\n"
        "45@35@20@1. **요약 평가**SPLIT1번 문항에 대한 답변 문장1PARAGRAPH문장2PARAGRAPH문장3SEPARATOR2. **전략평가**SPLIT2번 문항에 대한답변 문장1PARAGRAPH문장2PARAGRAPH문장3SEPARATOR3. ..."
    )
